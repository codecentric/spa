...
public class EntityWrapper {
     ...
     */
    private EntityWrapper(PersistenceContext context) {
     ...
     */
    public static EntityWrapper getInstance(PersistenceContext context) {
        if (INSTANCE == null) {
     ...
     * @param clazz
     */
    public <T> void batchInsert(List<T> collection, Class<?> clazz) {
        EntityHelper<T> entityHelper = (EntityHelper<T>) getEntityHelper(clazz);
        entityHelper.batchInsert(collection);
    }
