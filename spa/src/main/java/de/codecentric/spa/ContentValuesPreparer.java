...
public class ContentValuesPreparer {
    ...
    public ContentValuesPreparer(PersistenceContext context) {
    ...
    /**
     * Method checks if given value is null and, if it is, puts the null value in the given values map. If given value is null, method will return true which should signal that value is already placed
     * in the map and should be skipped by any of methods like {@link #prepareBooleanValue(ContentValues, Object, FieldMetaData, Field)} ,
