...
public class FieldScanner {
    ...
    /**
     * Method checks if the given field is relationship field, i.e. if it is annotated with one of annotations defining any kind of relationship (one-to-one, one-to-many, many-to-one, many-to-many).
     * 
     * @param f
    ...
    public static boolean isRelationshipField(Field f) {
        ...
        return f.getAnnotation(OneToOne.class) != null || f.getAnnotation(OneToMany.class) != null || f.getAnnotation(ManyToOne.class) != null || f.getAnnotation(ManyToMany.class) != null;
    }
    ...
    /**
     * Method scans {@link Field} on which is declared one-to-one relationship between two entity classes and sets appropriate columns as primary key for child of this relationship.
     * 
     * @param f
     *            field to scan
     */
    ...
    /**
     * Method scans {@link Field} on which is declared one-to-many relationship between two entity classes and puts appropriate {@link RelationshipMetaData} into {@link RelationshipMetaDataProvider}.
     * 
     * @param f
     *            field to scan
     */
    ...
    /**
     * Method scans {@link Field} on which is declared many-to-one relationship between two entity classes and puts appropriate {@link RelationshipMetaData} into {@link RelationshipMetaDataProvider}.
     * 
     * @param f
     *            field to scan
     */
