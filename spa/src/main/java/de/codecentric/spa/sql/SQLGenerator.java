...
/**
 * SQLGenerator is class that generates basic SQL statements (such as 'select', 'update', 'insert' or 'delete' queries) based on {@link EntityMetaData} derived from {@link EntityScanner} scanning.
 */
public class SQLGenerator {
    ...
    /**
     * Method generated SQL statement used to update values of database table. Method assumes that {@link EntityMetaData#getIdentifier()} will return not null value. If it does, null SQL statement is
     * returned.
     * 
     * Statement is generated based on {@link EntityMetaData} parameter. If meta data does not contain table name, method will return empty string.
     * 
    ...
    private static String generateUpdateSQL(EntityMetaData metaData) {
        ...
        if (tableName != null && !"".equals(tableName)) {
            ...
            sb.append(" WHERE ").append(metaData.getIdentifier().getColumnName()).append(" = ?");
        }
    ...
    /**
     * Method generated SQL statement used to select single record from database table. Method assumes that {@link EntityMetaData#getIdentifier()} will return not null value. If it does null SQL
     * statement is returned.
     * 
     * Statement is generated based on {@link EntityMetaData} parameter. Record is identified using table identifier field, returned by {@link EntityMetaData#getIdentifier()}. If meta data does not
     * contain table name, method will return empty string.
     * 
     * @param metaData
     *            table descriptor
    ...
    /**
     * Method generated SQL statement used to delete record from database table. Method assumes that {@link EntityMetaData#getIdentifier()} will return not null value. If it does null SQL statement is
     * returned.
     * 
     * Statement is generated based on {@link EntityMetaData} parameter. Record is identified using table identifier field, returned by {@link EntityMetaData#getIdentifier()}. If meta data does not
     * contain table name, method will return empty string.
    ...
    private static String generateCreateTableSQL(EntityMetaData metaData) {
        ...
        if (tableName != null && !"".equals(tableName)) {
            ...
            FieldMetaData idFld = metaData.getIdentifier();
            if (idFld != null) {
                sb.append(idFld.getColumnName()).append(' ').append(idFld.getColumnType()).append(" PRIMARY KEY");
            }
            ...
            if (fldMetaDataList != null && !fldMetaDataList.isEmpty()) {
                ...
                for (int i = 0; i < fldMetaDataList.size(); i++) {
                    FieldMetaData fldMData = fldMetaDataList.get(i);
                    sb.append(fldMData.getColumnName()).append(' ').append(fldMData.getColumnType());
                    if (i < fldMetaDataList.size() - 1) {
                        sb.append(", ");
                    }
                }
