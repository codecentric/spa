...
public class ConditionBuilder {
    ...
    /**
     * Variable defining grouping level. A group represents a statement inside brackets. Every time a group is opened, grouping level is incremented and, vice-versa - every time group is closed,
     * grouping level is decremented. At the end of building condition, grouping level should be zero.
     */
    ...
    public ConditionBuilder closeGroup() throws IllegalStateException {
        ...
        if (groupingLevel < 0) {
            throw new IllegalStateException("Grouping level is less than zero. More brackets is closed than is opened.\nCondition content:\n" + sb.toString());
        }
    ...
    public String build() throws IllegalStateException {
        if (groupingLevel != 0) {
            throw new IllegalStateException("Grouping level is not zero. Some brackets remained open.\nCondition content:\n" + sb.toString());
        }
